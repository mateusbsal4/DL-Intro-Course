...
class KeypointModel(nn.Module):
    ...
    def __init__(self, hparams):
        ...
        Warning: Don't change the method x  laration (i.e. by adding more
        ...
        self.model = nn.Sequential(
            nn.Conv2d(1, 32, kernel_size=4),        #93
            nn.LeakyReLU(),
            nn.MaxPool2d(kernel_size=2),            #46
            nn.Conv2d(32, 64, kernel_size=3),               #44
            nn.LeakyReLU(),
            nn.MaxPool2d(kernel_size=2),            #22
            nn.Conv2d(64, 128, kernel_size=2),      #21
            nn.LeakyReLU(),
